...
<div id="registerdiv" class="pop-up hide">
    ...
    <form id="registerform" method="post" name="registerform">
        <table name="registertable">
            ...
            <tr><td><p class="reg-boxs">密码： </p></td><td><input type="password" placeholder="密码" class="gray"id="in2" onclick="c1()" name="user_password"></td><td class="remainder2 hide" id="rm4">*至少六位</td><td class="remainder2 hide" id="rm5">*不能与昵称相同</td><td class="remainder2 hide" id="rm6">*不可为空</td></tr>
