...
<div id="registerdiv" class="pop-up hide">
    ...
    <form id="registerform" method="post" name="registerform">
        <table name="registertable">
            <tr><td><p class="reg-boxs">昵称： </p></td><td><input type="text" placeholder="昵称" class="gray" id="in1" name="user_name" autocomplete="off" maxlength="10"></td><td class="remainder2 hide" id="rm1">*至少六位</td><td class="remainder2 hide" id="rm2">*需要数字和字母</td><td class="remainder2 hide" id="rm3">*不可为空</td><td class="remainder2 hide" id="rm13">*用户名已存在</td></tr>
            ...
            <tr><td><p class="reg-boxs">邮箱： </p></td><td><input type="text" placeholder="邮箱" class="gray"id="in4" onclick="c3();c2();c1()" name="user_email" autocomplete="off"></td><td class="remainder2 hide" id="rm8">*不得为空</td><td class="remainder2 hide" id="rm9">*格式不正确</td></tr>
            <tr><td><p class="reg-boxs">电话： </p></td><td><input type="text" placeholder="电话" class="gray"id="in5" onclick="c1();c2();c3();c4()" name="user_tel" autocomplete="off"></td><td class="remainder2 hide" id="rm10">*不得为空</td><td class="remainder2 hide" id="rm11">*格式不正确</td></tr>
            <tr><td><p class="reg-boxs">地址： </p></td><td><input type="text" placeholder="地址" class="gray"id="in6" onclick="c5();c4();c3();c2();c1()" name="user_address" autocomplete="off"></td><td class="remainder2" id="rm12">*</td></tr>
