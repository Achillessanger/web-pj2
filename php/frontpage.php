...
//if(isset($_GET['a'])){
//    $_SESSION['trace'] = "";
//    echo "<script>test();window.location.href=\"frontpage.php\"</script>";//alert(\"请先登录\")
//
//}
?>
<!DOCTYPE html>
...
<script>
    function showNeedLoginFirst() {
        document.getElementById('loginfirst').classList.remove('hide');
        setTimeout(hideNeedLogin,500);
    }
    function hideNeedLogin() {
        document.getElementById('loginfirst').classList.add('hide');
...
if(isset($_GET['a'])){
    $_SESSION['trace'] = "";
    echo "<script>showNeedLoginFirst();</script>";//alert(\"请先登录\")
}
?>
